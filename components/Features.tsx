...
const FeatureItem = ({title ,icon  , description}:FeatureItem)=>(
 <li className=' flex flex-col flex-1 items-start  '>
  ...
  return (
    <section className=' flexCenter flex-col overflow-hidden bg-feature-bg bg-center bg-no-repeat py-24'>
      <div className='max-container  padding-container relative w-full flex justify-end '>
       ...
       <div className='  flex flex-col z-20 lg:w-[60%] w-full'>
       <div className='relative'>

        <Image  src='/camp.svg' alt='camp' width={50} height={50}
        className='absolute left-[-5%] top-[-28px] w-10 lg:left-[-2%] lg:top-[-20px] '
        />
